export default function FullClockDial({ time, isDarkMode }) {
    ...
    const mainColor = isDarkMode ? '#e2e8f0' : '#1e293b';
    const thickTickColor = isDarkMode ? '#e2e8f0' : '#1e293b';
    const thinTickColor = isDarkMode ? '#475569' : '#94a3b8';
    const secondColor = isDarkMode ? '#f87171' : '#ef4444';
    ...
    return (
        <div className="flex flex-col items-center">
            <div 
                className="relative rounded-full shadow-xl dark:shadow-slate-900/50 border-[5px] bg-white dark:bg-slate-800 border-slate-800 dark:border-slate-700 transition-colors duration-300"
